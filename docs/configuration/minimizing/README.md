...
> (`minimize { r8 { ... } }`), Shadow cannot determine which source files correspond to classes removed by R8.
> Therefore, the shadowed sources JAR will contain all relocated source files without responding to R8 shrinking
> results.
>
