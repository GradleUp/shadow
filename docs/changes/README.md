...
## What's Changed
* Fix the plugin dependency identifier in the docs by @lnhrdt in https://github.com/johnrengelman/shadow/pull/754
* mergeGroovyExtensionModules() not working with Groovy 2.5+ by @paulk-asert in https://github.com/johnrengelman/shadow/pull/779
