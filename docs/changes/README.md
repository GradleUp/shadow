...
- Move injecting `Class-Path` manifest attr logic from `doFirst` into `copy`. ([#1722](https://github.com/GradleUp/shadow/pull/1722))
- Deprecate `InheritManifest`. ([#1720](https://github.com/GradleUp/shadow/pull/1720))
