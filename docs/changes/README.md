...
## [9.0.0](https://github.com/GradleUp/shadow/compare/9.0.0) - Unreleased
...
- **BREAKING CHANGE:** Change the default `duplicatesStrategy` from `EXCLUDE` to `INCLUDE`. ([#1233](https://github.com/GradleUp/shadow/pull/1233))
    ...
    - See more details at [Handling Duplicates Strategy](../configuration/merging/README.md#handling-duplicates-strategy).
