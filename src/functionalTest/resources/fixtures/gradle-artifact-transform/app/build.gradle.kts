...
application { mainClass = "com.company.Main" }
...
tasks.shadowJar { configurations = project.configurations.runtimeClasspath.map { listOf(it) } }

configurations.runtimeClasspath { attributes.attribute(transformedAttribute, true) }
