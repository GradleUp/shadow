...
class SimpleRelocator @JvmOverloads constructor(
    ...
    @get:Input
    @get:Optional
    val pattern: String? get() = _pattern

    @get:Input
    val pathPattern: String get() = _pathPattern

    @get:Input
    @get:Optional
    val shadedPattern: String? get() = _shadedPattern

    @get:Input
    val shadedPathPattern: String get() = _shadedPathPattern

    @get:Input
    val isRawString: Boolean get() = _isRawString

    @get:Input
    val includes: Set<String> get() = _includes

    @get:Input
    val excludes: Set<String> get() = _excludes
