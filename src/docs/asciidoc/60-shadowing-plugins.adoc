...
`ShadowJar` task and collets the package names contained within them. It then configures relocation for these
...
provided by the Gradle runtime when executing the plugin. Thus, it is __not__ adviseable to bundle these dependencies
with your plugin.