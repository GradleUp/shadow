...
* https://github.com/ttsiebzehntt[Martin Sadowski] - Update to ASM 6.1
* https://github.com/sgnewson[Scott Newson] - Fix deprecated Gradle warnings https://github.com/johnrengelman/shadow/pull/356[#356]
