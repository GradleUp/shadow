...
----
include::{tests}/RelocationSpec.groovy[tags=relocate;relocate2]
----
...
****
**NOTE**: Relocation operates at a package level.
It is not necessary to specify any patterns for matching, it will operate simply on the prefix
provided.
****

****
**NOTE-2**: Relocation will be applied globally to all instance of the matched prefix.
...
[source,groovy,indent=0]
----
include::{tests}/RelocationSpec.groovy[tags=relocateFilter;relocateFilter2]
----
