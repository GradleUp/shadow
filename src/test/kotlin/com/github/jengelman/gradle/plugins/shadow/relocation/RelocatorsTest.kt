...
private class RelocatorsTest {
  ...
  companion object {
    ...
    val primitiveTypePatterns = primitiveTypes.map {
      ...
      "(${it}Lorg/package/ClassA;)V" to "(${it}Lshadow/org/package/ClassA;)V"
    }

    val signaturePatternsProvider =
      listOf(
        // Normal class: `org.package.ClassA`
        "Lorg/package/ClassA;" to "Lshadow/org/package/ClassA;",
        ...
        "Lorg/package/ClassA;Lorg/package/ClassB;" to
          "Lshadow/org/package/ClassA;Lshadow/org/package/ClassB;",
        // Multiple classes: `java.lang.Object org.package.ClassB`
        "Ljava/lang/Object;Lorg/package/ClassB;" to "Ljava/lang/Object;Lshadow/org/package/ClassB;",
        ...
        "org/package/ClassA" to "shadow/org/package/ClassA",
        // Method descriptor formats found in lambda deserialization metadata
        "(Lorg/package/ClassA;)Ljava/lang/String;" to
          "(Lshadow/org/package/ClassA;)Ljava/lang/String;",
        "(Lorg/package/ClassA;I)V" to "(Lshadow/org/package/ClassA;I)V",
        "(ILorg/package/ClassA;)V" to "(ILshadow/org/package/ClassA;)V",
        "(Lorg/package/ClassA;Lorg/package/ClassB;)Lorg/package/ClassA;" to
